...
private:
    ...
    // forward_vol_bp scales the configured half-spread before the inventory skew is
    ...
    double delta_bid(double forward_vol_bp, double position_limit_usage);
    double delta_ask(double forward_vol_bp, double position_limit_usage);
