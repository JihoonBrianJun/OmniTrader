...
void Pricer::publish_fair_price(const std::string& product) {
    ...
    auto fair_price_msg = FairPriceMsg{
        ...
        .fair_price_data = FairPriceData{
            ...
            .forward_vol_bp = result.forward_vol_bp
        }
    };
    ...
    LOG_INFO(
        logger_, "[FairPrice] {} fair={} mid={} factor={} forward_vol_bp={} bbid={}@{} bask={}@{}",
        product, result.fair_price, result.mid_price, result.factor, result.forward_vol_bp,
